...
def SearchResult():                    # 검색기준 선택, 검색이름 입력후 검색 클릭시 커멘드
    ...
    ResultSearch=(RentSearch1.Search(InStandard,InSearch))
...
def SearchWindow():
    ...
    OutpuTreeview.column('#2',width=130,anchor='e')
    OutpuTreeview.heading('#2',text='ISBN',anchor='center')
    OutpuTreeview.column('#3',width=100,anchor='e')
    OutpuTreeview.heading('#3',text='저자',anchor='center')
    OutpuTreeview.column('#4',width=93,anchor='e')
    OutpuTreeview.heading('#4',text='출판사',anchor='center')
    OutpuTreeview.column('#5',width=80,anchor='e')
